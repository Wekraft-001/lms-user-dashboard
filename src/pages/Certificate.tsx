...
const Certificate = () => {
  ...
  const moduleTitle = moduleId === "final" 
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      pdf.save(`Kujua360-Certificate-${userData.name.replace(/\s+/g, "-")}.pdf`);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="overflow-hidden shadow-2xl mb-8">
            ...
            >
              {/* Decorative Border */}
              <div className="absolute inset-4 border-4 border-double pointer-events-none"
              ...
              <div className="relative h-full flex flex-col items-center justify-between text-center">
                ...
                <div className="space-y-6 flex-1 flex flex-col justify-center">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold px-8 py-2 border-b-2 inline-block"
                  ...
                  <h4 className="text-xl md:text-2xl font-semibold max-w-2xl mx-auto"
                    style={{ color: "#002776" }}
                  >
                    {moduleTitle}
                  </h4>
                  ...
                  <p className="text-base" style={{ color: "#000000" }}>
                    as part of the <strong>Kujua360: Knowing Together, Acting Faster</strong> learning program
                  </p>
                </div>

                {/* Footer */}
                <div className="w-full grid grid-cols-2 gap-8 pt-8 border-t"
                  style={{ borderColor: "#e5e7eb" }}
                >
                  <div>
                    <div className="w-32 h-px mx-auto mb-2"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Explore more modules and deepen your understanding of CLM and PPR integration.
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Browse our library of materials, videos, and policy briefs to support your work.
              </p>
              <Button variant="outline" className="w-full">
                Visit Library
              </Button>
